...
import net.pollet.thorium.antlr.ThoriumBaseVisitor;
import net.pollet.thorium.antlr.ThoriumParser;
import net.pollet.thorium.data.method.Method;
import net.pollet.thorium.execution.values.Constant;
import net.pollet.thorium.execution.values.Symbol;
import net.pollet.thorium.execution.values.Variable;
