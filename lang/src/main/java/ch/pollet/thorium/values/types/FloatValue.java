 ...
 */
public class FloatValue extends BaseValue<FloatValue> {
    public Double value;
    ...
    public FloatValue operatorPlus(IntegerValue right) {
        return new FloatValue(value + right.getInternalValue());
    }
    ...
    public FloatValue operatorMultiply(IntegerValue right) {
        return new FloatValue(value * right.getInternalValue());
    }
    ...
    public boolean equals(Object o) {
        ...
        FloatValue floatType = (FloatValue) o;
