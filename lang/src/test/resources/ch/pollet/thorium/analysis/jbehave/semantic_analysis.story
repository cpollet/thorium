...
| 1 + true;                                                     | ch.pollet.thorium.analysis.exceptions.InvalidSymbolException          | Method Integer\.\+\(Boolean\) not implemented on line [0-9]+:[0-9]+ \(1\).                              |
...
| def Integer a = 0; def Float a = 0.0;                         | ch.pollet.thorium.analysis.exceptions.InvalidSymbolException          | Identifier a already defined on line [0-9]+:[0-9]+ \(def\) \(was on line [0-9]+:[0-9]+ \(def\)\).         |
...
| 1 > true;                                                     | ch.pollet.thorium.analysis.exceptions.InvalidSymbolException          | Method Integer\.>\(Boolean\) not implemented on line [0-9]+:[0-9]+ \(1\).                               |
| 1 >= true;                                                    | ch.pollet.thorium.analysis.exceptions.InvalidSymbolException          | Method Integer\.>=\(Boolean\) not implemented on line [0-9]+:[0-9]+ \(1\).                              |
| 1.0 < true;                                                   | ch.pollet.thorium.analysis.exceptions.InvalidSymbolException          | Method Float\.<\(Boolean\) not implemented on line [0-9]+:[0-9]+ \(1\.0\).                              |
| 1.0 <= true;                                                  | ch.pollet.thorium.analysis.exceptions.InvalidSymbolException          | Method Float\.<=\(Boolean\) not implemented on line [0-9]+:[0-9]+ \(1\.0\).                             |
| 1.0 > true;                                                   | ch.pollet.thorium.analysis.exceptions.InvalidSymbolException          | Method Float\.>\(Boolean\) not implemented on line [0-9]+:[0-9]+ \(1\.0\).                              |
| 1.0 >= true;                                                  | ch.pollet.thorium.analysis.exceptions.InvalidSymbolException          | Method Float\.>=\(Boolean\) not implemented on line [0-9]+:[0-9]+ \(1\.0\).                             |
| !1;                                                           | ch.pollet.thorium.analysis.exceptions.InvalidSymbolException          | Method Integer\.!\(\) not implemented on line [0-9]+:[0-9]+ \(!\).                                      |
| !1.0;                                                         | ch.pollet.thorium.analysis.exceptions.InvalidSymbolException          | Method Float\.!\(\) not implemented on line [0-9]+:[0-9]+ \(!\).                                        |
