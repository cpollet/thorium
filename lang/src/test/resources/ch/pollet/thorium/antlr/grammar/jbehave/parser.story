...
Then the exception <exception> is thrown with message starting with <message>
...
| { 1; } + 1;   | org.antlr.v4.runtime.misc.ParseCancellationException  | line 1:7 extraneous input '+' expecting       |
